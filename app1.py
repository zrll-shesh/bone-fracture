...
with tab5:
    ...
    ---
    **Disclaimer**: This system is designed for research and educational purposes, as the developed model has not yet reached optimal performance, with a recall of 0.4 and a precision of 0.7. Therefore, the results generated by this platform should not be used as a clinical medical diagnosis. This platform serves as a prototype and proof of concept for a bone fracture detection system developed specifically for the RisetLab essay competition. Further improvements are required in terms of data quality, model architecture, and training strategies to enhance performance and reliability in future developments. 
